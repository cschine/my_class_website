...
# look at the levels in man_lumped variable
mpg |>
  pull(man_lumped) |>
  levels()
```
...
We can also control aspect of the table and how it looks using arguments in the `kbl()` and `kable_styling()` functions. 
