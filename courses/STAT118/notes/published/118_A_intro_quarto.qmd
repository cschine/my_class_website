...
author: "Emily Malcolm-White (slightly altered by Casey Schine)"
format:
  html: 
    toc: TRUE
    code-overflow: wrap
...
If you have not already, please refer to the Installation Guide to install R and RStudio on your computer. 
